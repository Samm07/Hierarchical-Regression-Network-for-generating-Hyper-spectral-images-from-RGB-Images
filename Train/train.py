...
if __name__ == "__main__":
    ...
    # Training parameters
    parser.add_argument('--epochs', type = int, default = 1, help = 'number of epochs of training that ensures 100K training iterations')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '/content/drive/MyDrive/Mini Project Datasets/', help = 'baseroot')
